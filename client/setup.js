var topic=["Semester-1 Paper-1","Semester-2 Paper-2","Semester-3 Paper-3","Semester-4 Paper-4","Semester-5 Paper-5","Semester-5 Paper-6","Semester-6 Paper-7(A)","Semester-6 Paper-8(A)","Semester-6 Paper-8(B)","Semester-6 Paper-8(C)"];
...
var j=0,k=0;
var ids="",idi,idj,idsem="";
var upperdiv = document.getElementsByClassName("sems");
for(var i=0;i<topic.length;i++){
var divTag = document.createElement("DIV");
var title =document.createElement("H3");
var textnode = document.createTextNode(topic[i]);
title.appendChild(textnode);
divTag.appendChild(title);
var title2 =document.createElement("H4");
var textnode2 = document.createTextNode(topic2[i]);
title2.appendChild(textnode2);
divTag.appendChild(title2);
var underline = document.createElement("HR");
divTag.appendChild(underline);
  var firstUl = document.createElement("UL");
  idi=0;
  idsem="";
  var semester=topic[i][9];
  if(semester<'6')
  {
      idsem= 's'+topic[i][9]+'p'+topic[i][topic[i].length -1];
  }
  else{
    idsem='s'+topic[i][9]+'p'+topic[i][topic[i].length -4]+topic[i][topic[i].length-2];
  }
while(j<=units.length-1 && units[j]!="-1"){
  idi++;
  ...
  firstli.appendChild(pp);
  firstUl.appendChild(firstli);
  var secUl = document.createElement("UL");
  att = document.createAttribute("class");
  att.value ="topics";
  secUl.setAttributeNode(att);
  idj=0;
   while(k<=subunits.length-1 && subunits[k]!="-1"){
     idj++;
      var secLi = document.createElement("LI");
      var suunit = document.createTextNode(subunits[k]);
      ids="";
      ids+=idsem+'c'+idi+'t'+idj;
      secLi.appendChild(suunit);
      secUl.appendChild(secLi);
      var att1 = document.createAttribute("id");
      att1.value =ids;
      secLi.setAttributeNode(att1);
      k++;
    }
    k++;
    firstli.appendChild(secUl);
  j++;
}j++;
divTag.appendChild(firstUl);
upperdiv[0].appendChild(divTag);
}
});
